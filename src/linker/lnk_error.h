...
internal void lnk_errorfv(LNK_ErrorCode code, const char *fmt, va_list args);
internal void lnk_error(LNK_ErrorCode code, const char *fmt, ...);
internal void lnk_error_with_loc(LNK_ErrorCode code, String8 obj_path, String8 lib_path, const char *fmt, ...);
internal void lnk_supplement_error(const char *fmt, ...);
...
internal void lnk_internal_error(LNK_InternalError code, char *file, int line, const char *fmt, ...);
